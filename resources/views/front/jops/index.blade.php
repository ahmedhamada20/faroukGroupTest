                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="phone"  id="phone_number" required data-error="{{ __('index.phonerequired') }}" class="form-control @error('phone') is-invalid
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                <label>{{__('index.now_jobs')}}<span class="text-danger">*</span></label>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                <label>{{__('index.need_jobs')}}<span class="text-danger">*</span></label>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                <label>{{__('index.cv')}}<span class="text-danger">*</span></label>
