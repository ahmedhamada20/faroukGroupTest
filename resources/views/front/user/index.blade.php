        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title m-0">{{__('index.ur_control')}}</h4>
                    </div>
        ...
        <div class="col-xl-6 col-md-6">
            <div class="card bg-primary mini-stat text-white">
                <div class="p-3 mini-stat-desc">
                    <div class="clearfix">
                        <a href="{{route('customerProduct')}}">

                        <h6 class="text-uppercase mt-0 float-left text-white-50">{{__('index.my_products')}}</h6>

                        <h4 class="mb-3 mt-0 float-right">{{App\Models\RequestSercice::where('customer_id',auth()->user()->id)->count()}}</h4>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-info mini-stat text-white">
                    <div class="p-3 mini-stat-desc">
                        <div class="clearfix">
                            ...
                            <h6 class="text-uppercase mt-0 float-left text-white-50">{{__('index.open_ticket')}}</h6>
                                <h4 class="mb-3 mt-0 float-right">{{App\Models\Ticket::where('customer_id',auth()->user()->id)->count()}}</h4>
