    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li><a href="{{route('/dashboard/customer')}}">لوحه تحكمك</a></li>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-archive"></i> <span> منتجاتي </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                    <ul class="list-unstyled">
                        <li><a href="{{route('customerProduct')}}">منتجاتي</a></li>
                    </ul>
                </li>

                                <li>
                                    <a href="{{route('profile')}}" class="waves-effect"><i class="dripicons-calendar"></i><span> ملفي الشخصي </span></a>
                                </li>
