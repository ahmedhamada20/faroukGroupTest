...
@section('content')
 ...
 <div class="row">
                        <div class="col">
                           <a href="{{ route('downloadJobsExport') }}" class="btn btn-info">تنزيل البيانات</a>
                        </div>
                    </div>
                        ...
                        <table class="table text-md-nowrap text-center" id="example1">
                            ...
                            @forelse($data as $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{asset('project/public/public/image/'.$row->image)}}" download class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
                                    </td>
