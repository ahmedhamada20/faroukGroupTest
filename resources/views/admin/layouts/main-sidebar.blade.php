...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            @can('dashboard')
            <li class="side-item side-item-category">الصفحه الرئيسية</li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('dashboard') }}">
                    ...
                    <span class="side-menu__label">الصفحه الرئيسية</span></a>
            </li>
            @endcan

            @can('setting')
            <li class="side-item side-item-category">الاعدادات الرئيسية</li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('setting') }}">
                    ...
                    <span class="side-menu__label">الاعدادات الرئيسية</span></a>
            </li>
            @endcan
 ...
 @can('setting')
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('conteactIndex') }}">حدد احيتاجاتك </a></li>
                    ...
                    <li><a class="slide-item" href="{{ route('whatsapp') }}">طلب البرومو</a></li>
                    <li><a class="slide-item" href="{{ route('serversIndex') }}">استقصاء تحديد اتجاهات</a></li>
                </ul>
            </li>
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                            ...
                            <span class="side-menu__label">جميع الاستقصائات</span><i class="angle fe fe-chevron-down"></i></a>
                        <ul class="slide-menu">
